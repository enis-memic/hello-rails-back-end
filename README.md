...
# 📖 Hello Rails Api Only <a name="about-project"></a>
...
```sh
  cd Folder
  git clone git clone https://github.com/enis-memic/hello-rails-back-end.git
```
...
Feel free to check the [repo](https://github.com/enis-memic/hello-rails-back-end/issues)
